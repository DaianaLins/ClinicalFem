...
public class UsuarioAtendenteService{
    ...
    public boolean cadastrar(UsuarioAtendente usuario) throws InterruptedException, ExecutionException {
        
        //resgata todos os membros e verifica se há emails repetidos
        ArrayList<UsuarioAtendente> atendentes = getAllUsuarios(); boolean emailIgual = false;
    ...
    public ArrayList<UsuarioAtendente> getAllUsuarios() throws InterruptedException, ExecutionException {
    ...
    public boolean editar(UsuarioAtendente membro) throws InterruptedException, ExecutionException {
        ...
        //resgata todos os membros e verifica se há emails repetidos
        ArrayList<UsuarioAtendente> membros = getAllUsuarios(); boolean emailIgual = false;
