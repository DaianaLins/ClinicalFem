...
public class AgendamentoService {
    ...
    public Agendamento getAgendamentoByName(String nome) throws InterruptedException, ExecutionException{
        Agendamento agendamento = new Agendamento();
        
        CollectionReference agendamentos = (CollectionReference) conex.collection("Agendamentos");

        Query query = (Query) agendamentos.whereEqualTo("nome", nome);
        List<QueryDocumentSnapshot> querySnapshot = query.get().get().getDocuments();
